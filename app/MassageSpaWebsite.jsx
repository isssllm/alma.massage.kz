...
const CONTENT = {
  ru: {
    ...
    aboutText:
      'Более десяти лет практики в области лечебного и восстановительного массажа. Каждая программа строится индивидуально — с учётом состояния здоровья, целей и ощущений клиента.',
    aboutPoints: [
      {
  ...
  kk: {
    ...
    aboutText:
      'Емдік және қалпына келтіру массажы саласында он жылдан астам тәжірибе. Әр бағдарлама денсаулық жағдайын, мақсаттарды және клиенттің сезімін ескере отырып жеке құрылады.',
    aboutPoints: [
      {
        title: 'Жеке тәсіл',
